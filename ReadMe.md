# Shopping Sales Analysis 🛍️

## About data 📖

In this project, I conducted a comprehensive analysis of shopping sales data to uncover valuable insights into consumer behavior and sales trends.I processed and visualized the data to identify key patterns that can help retailers enhance their strategies.
...
1. Sales Insights: Evaluate discount impact, shipping preferences, and loyal customers.
2. Visualization: Create charts to highlight key insights.
3. Recommendations: Suggest strategies based on findings to boost sales and customer engagement.
...
Exploring the data reveals that the higher sales for males compared to females can be attributed to a higher count of male customers. However, when calculating the average sales per customer, both male and female averages are equal.
...
Discover key insights from the shopping sales dataset! With a total 19 columns, this comprehensive data includes detailed information on sales across various categories, demographics, and product types. Our analysis reveals significant trends, including the highest sales in categories like Clothing, and notable differences across age groups,  and shipping types. Additionally, we discovered that the M size consistently outperforms others in sales. Dive deeper into the dataset to unlock actionable insights that drive growth and strategy!
-------------
